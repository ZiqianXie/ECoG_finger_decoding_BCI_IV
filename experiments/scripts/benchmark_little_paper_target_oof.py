...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, default=Path("experiments/results/little-paper-target-oof.json")
    )
    parser.add_argument(
        "--figure", type=Path, default=Path("experiments/figures/little-paper-target-oof.png")
    )
