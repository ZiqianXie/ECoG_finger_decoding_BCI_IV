...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, default=Path("experiments/results/little-finger-training-only-audit.json")
    )
    parser.add_argument(
        "--figure", type=Path, default=Path("experiments/figures/little-finger-training-only-audit.png")
    )
    parser.add_argument(
        "--example-figure",
        type=Path,
        default=Path("experiments/figures/little-finger-training-only-examples.png"),
    )
