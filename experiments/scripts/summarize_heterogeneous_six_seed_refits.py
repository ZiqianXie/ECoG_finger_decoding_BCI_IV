...
def main() -> None:
    ...
    parser.add_argument("--config", type=Path, default=Path("experiments/configs/heterogeneous_six_seed_refit.yaml"))
    ...
    parser.add_argument(
        "--comparison-figure",
        type=Path,
        default=Path("experiments/figures/heterogeneous-six-seed-comparison.png"),
    )
